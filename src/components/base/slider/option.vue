...
<template>
  <div>
    ...
    <el-form-item label="变量">
      <el-input  type="text"  placeholder="请输入变量"  v-model="main.activeOption.valNm"> </el-input>
    </el-form-item>


    <el-form-item label="最小值">
      <el-input  type="text"  placeholder="请输入最小值"  v-model="main.activeOption.min"> </el-input>
    </el-form-item>
    <el-form-item label="最大值">
      <el-input  type="text"  placeholder="请输入最大值"  v-model="main.activeOption.max"> </el-input>
    </el-form-item>
    <el-form-item label="步长">
      <el-input  type="text"  placeholder="请输入步长"  v-model="main.activeOption.step"> </el-input>
    </el-form-item>
