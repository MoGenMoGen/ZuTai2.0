...
<template>
    <div>
        ...
        <el-form-item label="小数点位数">
            <avue-input-number v-model="main.activeOption.xsd" :max="5"></avue-input-number>
        </el-form-item>
        <el-form-item label="变量名称">
            <avue-input v-model="main.activeObj.mqtt" @click="selectVar('main.activeObj.mqtt')"></avue-input>
        </el-form-item>
        ...
        <el-collapse accordion>
            <el-collapse-item title="字体" name="1">
                ...
                <el-form-item label="字体行高">
                    <avue-input-number v-model="main.activeOption.lineHeight" :max="200"></avue-input-number>
            ...
            <el-collapse-item title="超链设置">
                ...
                <template v-if="main.activeOption.link">
                    <el-form-item label="打开方式">
                        <avue-radio v-model="main.activeOption.linkTarget" :dic="dicOption.target">
                        </avue-radio>
                    </el-form-item>
